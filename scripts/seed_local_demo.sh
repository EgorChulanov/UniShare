...
insert into public.stories (
    ...
    ('10000000-0000-4000-8000-000000000003', 'AirShare', 'Познакомьтесь рядом', 'Откройте AirShare, держите устройства рядом и нажмите «Начать».', 'wave.3.right.circle.fill', '64D8CB', 'Попробовать', 'unishare://airshare', 80, true, now(), now() + interval '30 days')

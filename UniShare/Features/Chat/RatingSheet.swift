...
struct RatingSheet: View {
                ...
                VStack(spacing: 28) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text(ratingMeaning)
                            ...
                            .foregroundStyle(rating == 0 ? theme.effectiveSecondaryTextColor : theme.effectivePrimary)
                            .frame(height: 18)
    ...
    private var ratingMeaning: String {
        switch rating {
        case 1: return "rating.meaning.1".localized
        case 2: return "rating.meaning.2".localized
        case 3: return "rating.meaning.3".localized
        case 4: return "rating.meaning.4".localized
        case 5: return "rating.meaning.5".localized
        default: return "rating.meaning.empty".localized
        }
    }
}
